...
import com.xy.xgpush.cloud.ClickAction;
import com.xy.xgpush.cloud.Style;
import com.xy.xgpush.cloud.TimeInterval;
import com.xy.xgpush.cloud.XingeApp;
import com.xy.xgpush.common.CommonWorkingThread;
import com.xy.xgpush.common.ExtendedListView;
...
//		}
	...
	private void step7() {
		...
		int ret_code = 0;
		try {
			com.xy.xgpush.cloud.Message message = new com.xy.xgpush.cloud.Message();
			message.setType(com.xy.xgpush.cloud.Message.TYPE_NOTIFICATION);
